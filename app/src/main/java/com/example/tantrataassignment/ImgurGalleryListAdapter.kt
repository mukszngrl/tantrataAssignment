...
import com.example.tantrataassignment.databinding.ListCellBinding
import com.example.tantrataassignment.model.Data

//For list view
class ImgurGalleryListAdapter(val data: List<Data>) :
    RecyclerView.Adapter<ImgurGalleryListAdapter.MyViewHolder>() {

    class MyViewHolder(private val itemViewCellBinding: ListCellBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemViewCellBinding =
            ListCellBinding.inflate(LayoutInflater.from(parent.context), parent, false)
